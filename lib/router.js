  ...
  this.route('home', {
    ...
    waitOn: function() { 
      return [Meteor.subscribe('currentUserLogged'),Meteor.subscribe('books'), Meteor.subscribe('authors'),                     Meteor.subscribe('stores'), Meteor.subscribe('rolePermissions'), Meteor.subscribe('procesos'),
              Meteor.subscribe('fichaIndicadores'), Meteor.subscribe('fuentes'), Meteor.subscribe('unidadesMedicion'), Meteor.subscribe('atributosNormativos'), Meteor.subscribe('entidadesReguladoras'), Meteor.subscribe('normas')];
    },
...
////////// fichaIndicadores ///////////////////////////////////////////////////////////////////
  ...
  this.route('fichaIndicadorPage', {
    ...
    waitOn: function() { 
      return [Meteor.subscribe('currentUserLogged'), Meteor.subscribe('fichaIndicadores'), Meteor.subscribe('procesos'), Meteor.subscribe('fuentes'),Meteor.subscribe('unidadesMedicion'),Meteor.subscribe('atributosNormativos'), Meteor.subscribe('asignacionesAtributoNormativoIndicador')];
    },
    onBeforeAction: function(){
      checkPermissions(['admin', 'crud-fichaIndicadores'])
    },
